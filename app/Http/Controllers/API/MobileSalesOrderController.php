...
class MobileSalesOrderController extends Controller
{
    ...
    {
       return ResourcesSalesOrder::collection(SalesOrder::where('medical_representative_id' , $request->user()->id)->whereNull('sync_date')->with(['customer', 'medicalRepresentative', 'saleItems'])->latest()->get());
    }
